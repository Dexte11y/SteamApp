...
class _DateFixture(_LiteralRoundTripFixture, fixtures.TestBase):
    ...
    def test_null_bound_comparison(self):
        # this tests is based on an Oracle issue observed in #4886.
...
class NumericTest(_LiteralRoundTripFixture, fixtures.TestBase):
    ...
    def do_numeric_test(self, metadata, connection):
        def run(type_, input_, output, filter_=None, check_scale=False):
            ...
            # tests that this is actually a number!
...
class JSONLegacyStringCastIndexTest(
    ...
    """tests JSON index access with "cast to string", which we have documented
