...
class ServerSideCursorsTest(
    ...
    @testing.combinations(
        ...
        # TODO: need a real requirement for this, or dont use this tests
        (
            "for_update_string",
            True,
            "SELECT 1 FOR UPDATE",
    ...
    def test_conn_option(self):
        ...
        with engine.connect() as conn:
            ...
            #
            # fun fact!  why did we not have this result.close() in this tests
            # before 2.0? don't we roll back in the connection pool
            # unconditionally? yes!  and in fact if you run this tests in 1.4
