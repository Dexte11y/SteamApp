...
def combinations(
    ...
    **kw: str,
    ...
    r"""Deliver multiple versions of a tests based on positional combinations.
    ...
    :param argnames: optional list of argument names.   These are the names
     of the arguments in the tests function that correspond to the entries
...
class Config:
    ...
    def pop(cls, namespace):
        if cls._stack:
            # a failed tests w/ -x option can call reset() ahead of time
