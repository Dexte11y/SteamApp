...
# current DB driver being used for a tests.
...
# loop is a more accurate tests for how SQLAlchemy's asyncio features
...
# --disable-asyncio flag is passed to the tests runner.
ENABLE_ASYNCIO = True
...
def _maybe_async(fn, *args, **kwargs):
    ...
    This function is used for tests setup/teardown and tests themselves
