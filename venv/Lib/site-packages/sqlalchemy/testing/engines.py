...
class ConnectionKiller:
    ...
    def prepare_for_drop_tables(self, connection):
        # don't do aggressive checks for third party tests suites
    ...
    def after_test_outside_fixtures(self, test):
        ...
        # on PostgreSQL, this will tests for any "idle in transaction"
    ...
    def stop_test_class_outside_fixtures(self):
        ...
        if pool.base._strong_ref_connection_records:
            ...
            if pool.base._strong_ref_connection_records:
                ...
                assert (
                    False
                ), "%d connection recs not cleared after tests suite" % (ln)
