...
class TestBase:
    ...
    # state after a tests is completed and before the outer teardown
    # starts
    ...
    def connection(self):
        ...
        if trans.is_active:
            trans.rollback()
        # trans would not be active here if the tests is using
    ...
    def trans_ctx_manager_fixture(self, request, metadata):
        ...
        t = Table("tests", metadata, Column("data", Integer))
        eng = getattr(self, "bind", None) or config.db
