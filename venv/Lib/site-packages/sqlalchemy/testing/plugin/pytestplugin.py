...
def setup_test_methods(request):
    ...
    # alembic tests suite is using setUp and tearDown
    # xdist methods; support these in the tests suite
    # for the near term
    if hasattr(self, "setUp"):
        asyncio._maybe_async(self.setUp)

    # inside the yield:
    # 4. function level fixtures defined on tests functions themselves,
    ...
    # 7. function level fixtures defined on tests functions
    ...
    #    depending on the flags defined by the tests class)
