...
internally::
    ...
    e = create_engine(
        "mssql+pyodbc://scott:tiger@mssql2017:1433/tests?"
...
can help make this easier::
    ...
    from sqlalchemy.engine import URL
    connection_string = "DRIVER={SQL Server Native Client 10.0};SERVER=dagger;DATABASE=tests;UID=user;PWD=password"
...
:func:`_sa.create_engine` , when using the **Microsoft ODBC driver only**::
    ...
    engine = create_engine(
        "mssql+pyodbc://scott:tiger@mssql2017:1433/tests?driver=ODBC+Driver+17+for+SQL+Server",
