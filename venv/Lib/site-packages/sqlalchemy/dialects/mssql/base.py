...
will remain consistent with the state of the transaction::
    ...
    mssql_engine = create_engine(
        "mssql+pyodbc://scott:tiger^5HHH@mssql2017:1433/tests?driver=ODBC+Driver+17+for+SQL+Server",
...
class MSSQLCompiler(compiler.SQLCompiler):
    ...
    def _render_json_extract_from_binary(self, binary, operator, **kw):
        ...
        # as with other dialects, start with an explicit tests for NULL
...
def _schema_elements(schema):
    ...
    # tests/dialect/mssql/test_reflection.py ->
    #           OwnerPlusDBTest.test_owner_database_pairs
    # tests/dialect/mssql/test_compiler.py -> test_force_schema_*
    # tests/dialect/mssql/test_compiler.py -> test_schema_many_tokens_*
    #
...
class MSDialect(default.DefaultDialect):
    ...
    def _setup_supports_nvarchar_max(self, connection):
        try:
            connection.scalar(
                sql.text("SELECT CAST('tests max support' AS NVARCHAR(max))")
            )
