...
* calling :func:`_sa.create_engine` with ``postgresql+psycopg://...`` will
  automatically select the sync version, e.g.::
    ...
    sync_engine = create_engine("postgresql+psycopg://scott:tiger@localhost/tests")
...
* calling :func:`_asyncio.create_async_engine` with
  ...
  e.g.::
    ...
    asyncio_engine = create_async_engine("postgresql+psycopg://scott:tiger@localhost/tests")

The asyncio version of the dialect may also be specified explicitly using the
``psycopg_async`` suffix, as::

    from sqlalchemy.ext.asyncio import create_async_engine
    asyncio_engine = create_async_engine("postgresql+psycopg_async://scott:tiger@localhost/tests")
