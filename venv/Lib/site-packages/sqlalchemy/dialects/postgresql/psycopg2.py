...
.. tip::
    ...
    that they are passed as explicit keyword arguments to :func:`_sa.create_engine()`::
        ...
        engine = create_engine(
            "postgresql+psycopg2://scott:tiger@localhost/tests",
...
connection URI::
    ...
    engine = sa.create_engine(
        "postgresql+psycopg2://scott:tiger@192.168.0.199:5432/tests?sslmode=require"
    )
...
class PGExecutionContext_psycopg2(_PGExecutionContext_common_psycopg):
    ...
    def _log_notices(self, cursor):
        ...
        # around tests suites such as SQLAlchemy's using a Mock object for
        # cursor
