...
class ORMSelectCompileState(ORMCompileState, SelectState):
    ...
    def _join_check_and_adapt_right_side(self, left, right, onclause, prop):
        ...
        # tests for joining to an unmapped selectable as the target
        ...
        if not need_adapter and aliased_entity:
            ...
            # tests/orm/inheritance/test_relationships.py.  There are also
        ...
        if need_adapter:
            ...
            # strictly necessary.
            # see tests/orm/test_core_compilation.py
