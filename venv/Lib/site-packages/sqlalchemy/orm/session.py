        ...
        *,
        ...
        :param join_transaction_mode: Describes the transactional behavior to
          ...
          * ``"create_savepoint"`` - the :class:`_orm.Session` will use
            ...
            a :class:`_orm.Session` into a tests suite where an externally
        ...
        # as long as it's False, so that external tests suites, oslo.db etc
        # continue to function as the argument appears to be passed in lots
        # of cases including in our own tests suite
        if autocommit:
    ...
    def _register_persistent(self, states: Set[InstanceState[Any]]) -> None:
        ...
        for state in states:
            ...
            if obj is not None:
                ...
                # are swapped; see tests/orm/test_naturalpks.py -> test_reverse
...
def close_all_sessions() -> None:
    ...
    This function is not for general use but may be useful for tests suites
