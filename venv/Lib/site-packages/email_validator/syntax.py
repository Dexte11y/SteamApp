...
def validate_email_domain_name(domain, test_environment=False, globally_deliverable=True):
    ...
    if globally_deliverable:
        ...
        # like. We'll skip this in tests environments to allow '@tests' email
        # addresses.
        if "." not in ascii_domain and not (ascii_domain == "tests" and test_environment):
    ...
    for d in SPECIAL_USE_DOMAIN_NAMES:
        ...
        if d == "tests" and test_environment:
            continue
