...
SPECIAL_USE_DOMAIN_NAMES = [
    ...
    # this library, so we reject "@tests" and "@*.tests" addresses, unless
    # the test_environment keyword argument is given, to allow their use
    # in application-level tests environments. These domains will generally
    # fail deliverability checks because "tests" is not an actual TLD.
    "tests",
]
