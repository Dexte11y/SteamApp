...
class TestLeaks(TestCase):
    ...
    def _check_issue251(self,
        ...
        # For the tests to be valid, even empty lists have to be tracked by the
        # GC
        ...
        def background_greenlet():
            ...
            # breaks this tests in all versions
        ...
        if not explicit_reference_to_switch and greenlet._greenlet.get_clocks_used_doing_optional_cleanup() is not None:
            ...
            # like to write a tests that proves that the main greenlet
            # sticks around, and we can on my machine (macOS 11.6,
            # MacPorts builds of everything) but we can't write that
            # same tests on other platforms. However, hopefully iteration
    ...
    def test_issue251_issue252_need_to_collect_in_background(self):
        ...
        #
        # Note that this tests sometimes spuriously passes on Linux,
    ...
    # the leakcheck makes an already slow tests slower.
    ...
    def _check_untracked_memory_thread(self, deallocate_in_thread=True):
        self._only_test_some_versions()
        # Like the above tests, but what if there are a bunch of
