...
def send_exception(g, exc):
    ...
    # the purpose of this tests is to explicitly check the propagation rules.
    def crasher(exc):
        raise exc
...
class TestGreenlet(TestCase):
    ...
    def test_instance_dict(self):
        ...
        self.assertEqual(g.__dict__, {'tests': 42})
    ...
    def test_parent_restored_on_kill(self):
        ...
        def worker():
            try:
                # Wait to be killed by going back to the tests.
                main.switch()
            except greenlet.GreenletExit:
    ...
    def test_threaded_updatecurrent(self):
        ...
        # check for this case at the end of green_updatecurrent(). This tests
    ...
    def test_tuple_subclass(self):
        ...
        # The point of this tests is to see what happens when a custom
        ...
        # This tests is really only relevant on Python 2. The builtin
    ...
    def test_implicit_parent_with_threads(self):
        if not gc.isenabled():
            return # cannot tests with disabled gc
        N = gc.get_threshold()[0]
        if N < 50:
            return # cannot tests with such a small N
        def attempt():
            lock1 = threading.Lock()
            lock1.acquire()
            lock2 = threading.Lock()
    ...
    def test_issue_245_reference_counting_subclass_no_threads(self):
        ...
        # The threaded tests crashed more reliably on more interpreters.
...
class TestGreenletSetParentErrors(TestCase):
    ...
    def test_unexpected_reparenting(self):
        ...
        # cleared, this tests is catching whether ``green_setparent``
