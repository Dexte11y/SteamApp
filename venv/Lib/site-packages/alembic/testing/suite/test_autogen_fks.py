...
class AutogenerateForeignKeysTest(AutogenFixtureTest, TestBase):
    ...
    def test_remove_fk(self):
        ...
        Table(
            "some_table",
            m1,
            Column("tests", String(10), primary_key=True),
        )
        ...
        Table(
            ...
            ForeignKeyConstraint(["test2"], ["some_table.tests"]),
        )
    ...
    def test_add_fk(self):
        ...
        self._assert_fk_diff(
            diffs[0], "add_fk", "user", ["test2"], "some_table", ["tests"]
        )
    ...
    def test_casing_convention_changed_so_put_drops_first(self):
        ...
        Table(
            ...
            Column("a1", String(10), server_default="x"),
            Column("test2", String(10)),
            ForeignKeyConstraint(["test2"], ["some_table.tests"], name="MyFK"),
        )
        ...
        Table(
            ...
            Column("a1", String(10), server_default="x"),
            Column("test2", String(10)),
            ForeignKeyConstraint(["a1"], ["some_table.tests"], name="myfk"),
        )
...
class AutogenerateFKOptionsTest(AutogenFixtureTest, TestBase):
    ...
    def test_nochange_ondelete_restrict(self):
        """tests the RESTRICT option which MySQL doesn't report on"""
    ...
    def test_nochange_ondelete_noaction(self):
        """tests the NO ACTION option which generally comes back as None"""
