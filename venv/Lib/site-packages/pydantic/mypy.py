        ...
        for field in fields:
            ...
            if sym_node is not None:
                ...
                if isinstance(var, Var):
                    ...
                    # See https://github.com/pydantic/pydantic/issues/5191 to hit this branch for tests coverage
                    self._api.defer()
                else:  # pragma: no cover
...
def error_unexpected_behavior(
    ...
    # Can't think of a good way to tests this, but I confirmed it renders as desired by adding to a non-error path
