...
# Get the current directory for our later tests cases.
...
class TestField(unittest.TestCase):
    ...
    def test_cache_expiration(self):
        self.f.write(b'tests')
        self.assertEqual(self.f.value, b'tests')
        self.f.write(b'123')
        self.assertEqual(self.f.value, b'test123')
...
class TestFile(unittest.TestCase):
    ...
    # TODO: tests uploading two files with the same name.
...
class TestFormParser(unittest.TestCase):
    ...
    def test_http(self, param):
        ...
        exc = None
        try:
            processed = self.f.write(param['tests'])
            self.f.finalize()
        ...
        # No error!
        self.assertEqual(processed, len(param['tests']))
    ...
    def test_random_splitting(self):
        """
        This tests runs a simple multipart body with one field and one file
    ...
    def test_feed_single_bytes(self):
        """
        This tests parses a simple multipart body 1 byte at a time.
        """
        # Load tests data.
        test_file = 'single_field_single_file.http'
        with open(os.path.join(http_tests_dir, test_file), 'rb') as f:
    ...
    def test_request_body_fuzz(self):
        """
        This tests randomly fuzzes the request body to ensure that no strange
    ...
    def test_request_body_fuzz_random_data(self):
        """
        This tests will fuzz the multipart parser with some number of iterations
    ...
    def test_querystring(self):
        ...
        def simple_test(f):
            ...
            self.assertEqual(fields[1].field_name, b'tests')
    ...
    def test_bad_content_transfer_encoding(self):
        data = b'----boundary\r\nContent-Disposition: form-data; name="file"; filename="tests.txt"\r\nContent-Type: text/plain\r\nContent-Transfer-Encoding: badstuff\r\n\r\nTest\r\n----boundary--\r\n'
