...
class Environment:
    ...
    def call_test(
        ...
        """Invoke a tests on a value the same way the compiler does.

        This might return a coroutine if the tests is running from an
        environment in async mode and the tests supports async execution.
